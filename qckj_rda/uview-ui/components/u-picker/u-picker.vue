<template>
	<u-popup v-model="value" mode="center" border-radius="20" width="686" :safeAreaInsetBottom="safeAreaInsetBottom"
		@close="close" :z-index="uZIndex" :maskCloseAble="maskCloseAble">
